...
const techTags = [".NET Framework", ".NET MVC", "3D", "Ab Initio", "Abacus", "Ada", "Adobe CS", "AEM", "Agentic AI", "AI", "AI Agents", "Airflow", "Airtable", "Akeneo", "Altium Designer", "Amazon DocumentDB",
  "ABAP", "AJAX", "Apex", "API", "Apigee", "Appium", "ARM", "ASP.NET", "AWS", "AWS Glue", "Lambda", "OpenSearch", "Redshift", "Active Directory", "ActiveMQ", "Airlock", "Akka", "AlpineJS", "Alteryx", "Android", "Angular", "Ansible", "Apache Camel", "Apache CXF",
  "Apache HTTP Server", "Apollo", "ArangoDB", "Architect", "ArchiMate", "Arduino", "ArgoCD", "Aruba", "asyncio", "Asterisk", "Atlassian", "Attraqt", "Avaloq", "AUTOSAR", "Azure", "Azure ML Ops", "Babel", "Bazel", "Big Data", "BigQuery", "BIM", "BPMN", "BSD ", "BSI CRM",
  ...
  "C", "C#", "C++", "CAFM", "CakePHP", "Camunda", "CAN", "Census", "ChatGPT", "CI/CD", "CICS", "Citrix", "Claude Code", "ClickHouse", "ClickUp", "CLIST", "Cloud", "CloudWatch", "CMDB", "CMMS", "CML", "CMS", "COBOL", "CockroachDB", "CodeIgniter", "Copilot", "CoreMedia CMS", "Cosmos DB", "Craft CMS",
  ...
  "EC2", "ECMAScript", "ELK", "ES6", "ESB", "ETL", "Eclipse", "Eclipse Scout", "ElasticSearch", "Electron", "Elixir", "Elm", "Embedded", "Embedded WebServer", "Embedding Models", "Ember", "Emscripten", "ERP",
  "EPCIS", "Erlang", "Exasol", "Excel", "Exposed", "ExpressJS", "ESLint", "EtherCAT", "Ethereum", "Ethernet", "F#", "FaaS", "FPGA", "Fabric", "FastAPI", "Fastlane", "Fiddler", "Figma", "FileMaker", "Fine-tuning", "Firebase", "Firewall", "Firmware", "Fivetran", "Foreman", "Fortran", "FortiGate", "Flask", "Flow",
  "Flexray", "Flink", "Flowable", "Flutter", "Flyway", "FreeRTOS", "Frontend", "Fullstack", "GameDev", "Gatsby", "GCP", "Germini", "Genesys", "GIS", "GNU", "Git", "GitHub", "GitLab", "GitOps", "Golang", "Gradle",
  "Grafana", "GraphQL", "Graph Database", "Graphite", "Graylog", "Groovy", "Grunt", "GUI Programming", "Gulp", "H2", "Hadoop", "Handlebars", "Hardware", "Hightouch", "HSM", "HTTP", "HTML5", "Haskell", "Helm", "Heroku", "Hexagonal Architecture", "HubSpot",
  "Hibernate", "Hive", "HL7", "HyperLynx", "Hyper-V", "IAM", "IBM", "IBM Db2", "IBM Mainframe", "IBM Spectrum", "IBM WebSphere", "ICT", "IaaS", "Icinga", "IdentityIQ", "IDoc", "IMS", "Incident Management", "Indesign", "InfiniBand",
  "Infor LN", "Informatica", "Instana", "Integromat", "IntelliJ", "InVision", "Ionic", "IoT", "Istio", "ISTQB", "Support", "ITIL", "ITSM", "Jackson", "JAXB", "JBoss", "JCL", "JFrog", "JHipster", "JIRA", "JPA", "JSON", "JSP", "JVM", "JUnit",
  "Jupyter", "JTA", "JWT", "Jasmine", "Java", "Java EE", "JavaFX", "JavaScript", "Jenkins", "Jest", "Jitsi", "JMeter", "Julia", "K2", "KIS", "KVM", "Kafka", "Kanban", "Karma", "Karpenter", "KEDA",
  "Keras", "Kibana", "Kotlin", "Ktor", "Kubeflow", "Kubernetes", "Kustomize", "LAN", "LDAP", "LESS", "LIS", "LLM", "Langfuse", "Laravel", "Leaflet", "Lightning Web Components", "Linux", "Liquibase", "Liquid", "LLVM", "Load Balancing", "Looker", "Lovable", "LXC",
  "LWC", "LVDS", "MPLS", "MS-SQL", "macOS", "MacBook", "Machine Learning", "Magento", "Magnolia CMS", "MariaDB", "Marketing", "Marvel", "Material UI", "Matlab", "Matrix", "Maven", "MCP", "MediaWiki", "Mendix", "Metabase",
  "Mesos", "Meteor", "Microsoft 365", "Microsoft BizTalk Server", "Microsoft Dynamics 365 BC", "Microsoft Dynamics 365 CRM", "Microsoft Dynamics 365 NAV", "Microsoft Intune", "Microsoft Power Platform", "MLflow", "MLOps", "Mocha", "MuleSoft",
  "Mustache", "Mobile", "Model Serving", "Model Training", "MongoDB", "mongoose", "Motoko", "MS Teams", "MQTT", "MVC", "MVVM", "MySQL", "multi-GbE", "n8n", "NAT", "NATS", "Neo4J", "Neos", "NestJS", "Network", "NextJS", "Nexus", "NFC", "NFS", "Nginx", "NgRx", "NHibernate",
  "NodeJS", "NoSQL", "NPM", "NuxtJS", "Nutanix", "Nx", "ODI", "OSS", "OWASP", "Objective-C", "OAuth", "OCaml", "Odoo", "Office 365", "OOP", "Open-E JovianDSS", "OpenAPI", "OpenGL", "OpenID", "OpenTelemetry",
  "OpenLayers", "OpenNebula", "OpenShift", "OpenStack", "OpenTripPlanner", "Oracle", "OutSystems", "PACS", "PCIe", "PHP", "PhpStorm", "PHPUnit", "pnpm",
  "PL SQL", "PL/I", "PLC", "PWA", "PaaS", "Pacemaker", "PagerDuty", "Palantir Foundry", "Pardot", "Perl", "Phoenix", "Pimcore", "Play Framework", "Playwright", "plentymarkets", "Podman", "Polymer", "PostgreSQL", "Postfix", "Postman", "Power BI", "PowerBuilder", "Power Query",
  "PowerShell", "PrestaShop", "Prisma", "proALPHA", "Process Mining", "Prometheus", "Product Manager", "Product Owner", "Progress OpenEdge", "Profibus", "Profinet", "Project Manager", "Protractor", "Pulumi", "Puppet", "PyTorch", "Python", "PySpark",
  "QA Testing", "QEMU", "Qlik", "Quobyte", "Qt", "Quant", "Quarkus", "R", "RAD-NeRF", "RAG", "RDF", "RDMA", "REST", "ReSharper", "RBAC", "RHEL", "RIS", "ROS", "RPA", "RSpec", "RabbitMQ", "Rails", "React",
  "React Native", "ReactiveX", "Redgate", "Redis", "Redux", "Renovate", "RevPi", "Robot Framework", "Robotics", "Roku", "RS-485", "Ruby", "Rust", "RxJava", "RxJs", "RxSwift", "SAP S/4HANA", "SAP BW/4HANA", "SAML", "SAP", "SAPUI5", "SAP Analytics Cloud",
  "SAP Analytics Designer", "SAP Commerce", "SAP Crystal Reports", "SAP BDC", "SAP BTP", "SAP CS", "SAP Databricks", "SAP Datasphere", "SAP EWM", "SAP FICO", "SAP Fiori", "SAP Lumira", "SAP MM", "SAP PM", "SAP PP", "SAP QM", "SAP Web Intelligence", "SAS", "SASS", "SCSS", "SDWAN", "SEV", "SGX", "SOAP", "SPS", "SQL", "SQLite",
  ...
  "strapi", "STM32CubeIDE", "StreamServe", "Svelte", "Swagger", "Swift", "Swing", "Symfony", "System Engineer", "SystemVerilog", "Tableau", "TailwindCSS", "Talend", "TCP/IP", "TDD", "TIBCO", "TOGAF", "TM1", "TMap", "TSO", "TSO/ISPF", "TSQL", "TYPO3",
  ...
  "Unity", "Unreal", "UVM", "UX UI Design", "VBA", "VPN", "VMware", "VR", "Vaadin", "Vagrant", "Veeam", "Verilog", "Vertx", "VHDL", "Video Streaming", "Vision AI", "Visual Basic", "VSAM",
  ...
  "dbt", "gRPC", "iOS", "jQuery", "microservices", "numpy", "opencv", "pandas", "pytest", "styled-components", "vLLM"]
...
const perkTagsTranslated = {
  en: {
    weeksvacation4: "4 weeks (20 days) vacation",
    weeksvacation5: "5 weeks (25 days) vacation",
    weeksvacation6: "6 weeks (30 days) vacation",
  ...
  de: {
    weeksvacation4: "4 Wochen (20 Tage) Urlaub",
    weeksvacation5: "5 Wochen (25 Tage) Urlaub",
    weeksvacation6: "6 Wochen (30 Tage) Urlaub",
  ...
  fr: {
    weeksvacation4: "4 semaines (20 jours) de vacances",
    weeksvacation5: "5 semaines (25 jours) de vacances",
    weeksvacation6: "6 semaines (30 jours) de vacances",
  ...
  nl: {
    weeksvacation4: "4 weken (20 dagen) vakantie",
    weeksvacation5: "5 weken (25 dagen) vakantie",
    weeksvacation6: "6 weken (30 dagen) vakantie",
  ...
  ro: {
    weeksvacation4: "4 saptamani (20 zile) de vacanta",
    weeksvacation5: "5 saptamani (25 zile) de vacanta",
    weeksvacation6: "6 saptamani (30 zile) de vacanta",
