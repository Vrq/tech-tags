...
const techTags = [".NET Framework", ".NET MVC", "3D", "Ab Initio", "Abacus", "Ada", "Adobe CS", "AEM", "Agentic AI", "AI", "AI Agents", "Airflow", "Airtable", "Akeneo", "Altium Designer", "Amazon DocumentDB",
  ...
  "Hibernate", "Hive", "HL7", "HyperLynx", "Hyper-V", "IAM", "IBM", "IBM Db2", "IBM Mainframe", "IBM Spectrum", "IBM WebSphere", "ICT", "IaaS", "Icinga", "IdentityIQ", "IDoc", "Incident Management", "Indesign", "InfiniBand",
  "Infor LN", "Informatica", "Instana", "Integromat", "IntelliJ", "InVision", "Ionic", "IoT", "Istio", "ISTQB", "Support", "ITIL", "ITSM", "Jackson", "JAXB", "JBoss", "JFrog", "JHipster", "JIRA", "JPA", "JSON", "JSP", "JVM", "JUnit",
  ...
  "PL SQL", "PLC", "PWA", "PaaS", "Pacemaker", "PagerDuty", "Pardot", "Perl", "Phoenix", "Pimcore", "Play Framework", "Playwright", "plentymarkets", "Podman", "Polymer", "PostgreSQL", "Postfix", "Postman", "Power BI", "PowerBuilder", "Power Query",
  ...
  "Unity", "Unreal", "UVM", "UX UI Design", "VBA", "VPN", "VMware", "VR", "Vaadin", "Vagrant", "Veeam", "Verilog", "Vertx", "VHDL", "Video Streaming", "Vision AI", "Visual Basic",
