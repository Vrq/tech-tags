...
const techTags = [".NET Framework", ".NET MVC", "3D", "Ab Initio", "Abacus", "Ada", "Adobe CS", "AEM", "AI", "Airflow", "Airtable", "Akeneo", "Altium Designer", "Amazon DocumentDB",
  ...
  "EPCIS", "Erlang", "Exasol", "Excel", "Exposed", "ExpressJS", "ESLint", "EtherCAT", "Ethereum", "Ethernet", "F#", "FaaS", "FPGA", "Fabric", "FastAPI", "Fastlane", "Fiddler", "Figma", "FileMaker", "Firebase", "Firewall", "Firmware", "Fivetran", "Foreman", "Fortran", "FortiGate", "Flask", "Flow",
  ...
  "Grafana", "GraphQL", "Graph Database", "Graphite", "Graylog", "Groovy", "Grunt", "GUI Programming", "Gulp", "H2", "Hadoop", "Handlebars", "Hardware", "Hightouch", "HSM", "HTTP", "HTML5", "Haskell", "Helm", "Heroku", "HubSpot",
  ...
  "Keras", "Kibana", "Kotlin", "Ktor", "Kubeflow", "Kubernetes", "LAN", "LDAP", "LESS", "LIS", "LLM", "Langfuse", "Laravel", "Leaflet", "Lightning Web Components", "Linux", "Liquibase", "Liquid", "LLVM", "Load Balancing", "Looker", "Lovable", "LXC",
  "LWC", "LVDS", "MPLS", "MS-SQL", "macOS", "MacBook", "Machine Learning", "Magento", "Magnolia CMS", "MariaDB", "Marketing", "Marvel", "Material UI", "Matlab", "Matrix", "Maven", "MediaWiki", "Mendix", "Metabase",
  ...
  "NodeJS", "NoSQL", "NPM", "NuxtJS", "Nutanix", "ODI", "OSS", "OWASP", "Objective-C", "OAuth", "OCaml", "Odoo", "Office 365", "OOP", "Open-E JovianDSS", "OpenAPI", "OpenGL", "OpenID", "OpenTelemetry",
  ...
  "PowerShell", "PrestaShop", "Prisma", "proALPHA", "Process Mining", "Prometheus", "Product Manager", "Product Owner", "Progress OpenEdge", "Profibus", "Profinet", "Project Manager", "Protractor", "Puppet", "PyTorch", "Python", "PySpark",
  "QA Testing", "QEMU", "Qlik", "Quobyte", "Qt", "Quant", "Quarkus", "R", "RAD-NeRF", "RDF", "RDMA", "REST", "ReSharper", "RBAC", "RHEL", "RIS", "ROS", "RPA", "RSpec", "RabbitMQ", "Rails", "React",
  "React Native", "ReactiveX", "Redgate", "Redis", "Redux", "RevPi", "Robot Framework", "Robotics", "Roku", "RS-485", "Ruby", "Rust", "RxJava", "RxJs", "RxSwift", "SAP S/4HANA", "SAP BW/4HANA", "SAML", "SAP", "SAPUI5", "SAP Analytics Cloud",
