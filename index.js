...
const techTags = [".NET Core", ".NET Framework", ".NET MVC", "3D", "Ab Initio", "Abacus", "Ada", "Adobe CS", "AEM", "Airflow", "Airtable", "Amazon DocumentDB",
  "ABAP", "AJAX", "API", "Appium", "ASP.NET", "AWS", "Active Directory", "ActiveMQ", "Airlock", "Akka", "Android", "Angular", "Ansible", "Apache Camel", "Apache CXF",
  ...
  "EPCIS", "Erlang", "ExpressJS", "ESLint", "Ethereum", "Ethernet", "F#", "FPGA", "Fastlane", "Figma", "Firebase", "Firewall", "Fivetran", "FortiGate", "Flask",
  "Flexray", "Flink", "Flutter", "Frontend", "Fullstack", "GameDev", "Gatsby", "GCP", "Genesys", "GIS", "GNU", "Git", "GitHub", "GitLab", "Golang", "Gradle",
  ...
  "Jupyter", "JWT", "Jasmine", "Java", "Java EE", "JavaFX", "JavaScript", "Jenkins", "Jest", "K2", "KVM", "Kafka", "Kanban", "Karma", "Keras", "Kotlin",
  "Kubernetes", "LDAP", "LESS", "Laravel", "Leaflet", "Linux", "Liquibase", "Load Balancing", "Looker", "LXC", "LWC", "MS-SQL", "Machine Learning", "Magento",
  "MariaDB", "Marketing", "Marvel", "Material UI", "Matlab", "Maven", "MediaWiki", "Mesos", "Meteor", "Microsoft BizTalk Server", "Microsoft Dynamics 365 CRM",
  "Mustache", "Mobile", "MongoDB", "MS Teams", "MQTT", "MVC", "MVVM", "MySQL", "NAT", "Neo4J", "Network", "NextJS", "Nexus", "NFC", "NFS", "Nginx", "NHibernate",
  "NodeJS", "NoSQL", "NuxtJS", "ODI", "OSS", "OWASP", "Objective-C", "Odoo", "Office 365", "Open-E JovianDSS", "OpenGL", "OpenShift", "OpenStack", "Oracle", "PHP",
  "PL SQL", "PLC", "PWA", "PaaS", "Pacemaker", "Pardot", "Perl", "Phoenix", "Pimcore", "Play Framework", "Polymer", "PostgreSQL", "Postman", "Power BI",
  "PowerShell", "PrestaShop", "Prometheus", "Product Manager", "Product Owner", "Profibus", "Profinet", "Project Manager", "Puppet", "PyTorch", "Python",
  "QA Testing", "QEMU", "Quobyte", "Qt", "Quarkus", "RDF", "RDMA", "REST", "ReSharper", "RBAC", "RHEL", "ROS", "RPA", "RSpec", "RabbitMQ", "Rails", "React",
  ...
  "strapi", "Svelte", "Swagger", "Swift", "Swing", "Symfony", "System Engineer", "SystemVerilog", "Tableau", "Talend", "TCP/IP", "TDD", "TSQL", "TYPO3",
