...
const techTags = [".NET Framework", ".NET MVC", "3D", "Ab Initio", "Abacus", "Ada", "Adobe CS", "AEM", "AI", "Airflow", "Airtable", "Akeneo", "Altium Designer", "Amazon DocumentDB",
  ...
  "C", "C#", "C++", "CAFM", "CakePHP", "Camunda", "CAN", "ChatGPT", "CI/CD", "Citrix", "Claude Code", "ClickHouse", "ClickUp", "Cloud", "CloudWatch", "CMDB", "CMMS", "CML", "CMS", "COBOL", "CockroachDB", "CodeIgniter", "Copilot", "CoreMedia CMS", "Cosmos DB", "Craft CMS",
  ...
  "Keras", "Kibana", "Kotlin", "Ktor", "Kubeflow", "Kubernetes", "LAN", "LDAP", "LESS", "LIS", "LLM", "Laravel", "Leaflet", "Lightning Web Components", "Linux", "Liquibase", "Liquid", "LLVM", "Load Balancing", "Looker", "Lovable", "LXC",
  "LWC", "LVDS", "MPLS", "MS-SQL", "macOS", "MacBook", "Machine Learning", "Magento", "Magnolia CMS", "MariaDB", "Marketing", "Marvel", "Material UI", "Matlab", "Matrix", "Maven", "MediaWiki", "Mendix",
