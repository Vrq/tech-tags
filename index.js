...
const techTags = [".NET Framework", ".NET MVC", "3D", "Ab Initio", "Abacus", "Ada", "Adobe CS", "AEM", "Airflow", "Airtable", "Akeneo", "Altium Designer", "Amazon DocumentDB",
  ...
  "C", "C#", "C++", "CAFM", "CakePHP", "Camunda", "CAN", "ChatGPT", "CI/CD", "Citrix", "ClickUp", "Cloud", "CloudWatch", "CMMS", "CML", "CMS", "COBOL", "CodeIgniter", "Cosmos DB", "Craft CMS", "Cryptography", "CODESYS", "CQRS", "CSS", "Cassandra", "Celery", "Ceph", "CheckMK",
  ...
  "QA Testing", "QEMU", "Quobyte", "Qt", "Quant", "Quarkus", "R", "RDF", "RDMA", "REST", "ReSharper", "RBAC", "RHEL", "RIS", "ROS", "RPA", "RSpec", "RabbitMQ", "Rails", "React",
