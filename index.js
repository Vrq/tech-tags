...
const techTags = [".NET Framework", ".NET MVC", "3D", "Ab Initio", "Abacus", "Ada", "Adobe CS", "AEM", "Airflow", "Airtable", "Akeneo", "Altium Designer", "Amazon DocumentDB",
  ...
  "C", "C#", "C++", "CAFM", "CakePHP", "Camunda", "CAN", "CI/CD", "Citrix", "ClickUp", "Cloud", "CloudWatch", "CMMS", "CML", "CMS", "COBOL", "CodeIgniter", "Cosmos DB", "Craft CMS", "Cryptography", "CODESYS", "CQRS", "CSS", "Cassandra", "Celery", "Ceph", "CheckMK",
  ...
  "Keras", "Kibana", "Kotlin", "Kubeflow", "Kubernetes", "LAN", "LDAP", "LESS", "LIS", "Laravel", "Leaflet", "Linux", "Liquibase", "LLVM", "Load Balancing", "Looker", "LXC",
