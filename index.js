...
const techTags = [".NET Framework", ".NET MVC", "3D", "Ab Initio", "Abacus", "Ada", "Adobe CS", "AEM", "AI", "Airflow", "Airtable", "Akeneo", "Altium Designer", "Amazon DocumentDB",
  ...
  "DApps", "Dapper", "Dart", "Data-Engineer", "Data-Science", "Data Vault", "Data Warehouse", "Databricks", "Datadog", "DatoCMS", "Debian", "Delphi", "DevExpress", "DevSecOps", "DevOps", "DXP", "Django", "Docker", "Doctrine", "Drupal", "Dynatrace", "E2E", "EAM",
  ...
  "EPCIS", "Erlang", "Exasol", "Exposed", "ExpressJS", "ESLint", "EtherCAT", "Ethereum", "Ethernet", "F#", "FaaS", "FPGA", "FastAPI", "Fastlane", "Fiddler", "Figma", "FileMaker", "Firebase", "Firewall", "Firmware", "Fivetran", "Foreman", "Fortran", "FortiGate", "Flask", "Flow",
  ...
  "NodeJS", "NoSQL", "NPM", "NuxtJS", "ODI", "OSS", "OWASP", "Objective-C", "OAuth", "OCaml", "Odoo", "Office 365", "OOP", "Open-E JovianDSS", "OpenAPI", "OpenGL", "OpenID", "OpenTelemetry",
  "OpenLayers", "OpenShift", "OpenStack", "OpenTripPlanner", "Oracle", "OutSystems", "PACS", "PCIe", "PHP", "PhpStorm", "PHPUnit", "pnpm",
  "PL SQL", "PLC", "PWA", "PaaS", "Pacemaker", "PagerDuty", "Pardot", "Perl", "Phoenix", "Pimcore", "Play Framework", "Playwright", "plentymarkets", "Podman", "Polymer", "PostgreSQL", "Postfix", "Postman", "Power BI", "PowerBuilder",
  ...
  "SAP Analytics Designer", "SAP Commerce", "SAP Crystal Reports", "SAP CS", "SAP EWM", "SAP FICO", "SAP Fiori", "SAP Lumira", "SAP MM", "SAP PM", "SAP PP", "SAP QM", "SAP Web Intelligence", "SAS", "SASS", "SCSS", "SDWAN", "SEV", "SGX", "SOAP", "SPS", "SQL", "SQLite",
