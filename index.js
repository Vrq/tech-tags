...
const techTags = [".NET Core", ".NET Framework", ".NET MVC", "3D", "Abacus", "Ada", "Adobe CS", "AEM", "Airflow", "AJAX", "API", "Appium", "ASP.NET", "AWS", "Active Directory", "ActiveMQ", "Airlock", "Akka", "Android",
  ...
  "Cucumber", "CUDA", "Cypress", "D3", "DDD", "DDN", "Dagger", "DApps", "Dapper", "Dart", "Data-Science", "Data Vault", "Data Warehouse", "DevExpress", "DevOps", "Django", "Docker", "Drupal", "E2E", "EC2", "ELK", "ES6", "ESB", "ETL", "Eclipse", "Eclipse Scout",
  ...
  "Mobile", "MongoDB", "MS Teams", "MySQL", "NAT", "Network", "NextJS", "Nexus", "NFC", "NFS", "Nginx", "NHibernate", "NodeJS", "NoSQL", "NuxtJS", "ODI", "OSS", "Objective-C", "Office365", "Open-E JovianDSS", "OpenGL", "OpenShift", "OpenStack",
...
const perkTagsTranslated = {
  ...
  ro: {
    ...
    beer: "Bere",
    bonuspay: "Remuneratie bonus",
    careerpath: "Calea carierei si revizuirea anuala",
    ...
    halffare: "Contributia transportului public",
    relocation: "Sprijin pentru relocare",
    sabbatical: "Posibilitate sabatica",
    standingdesk: "Birou in picioare",
    startupculture: "Cultura startupului",
    sweets: "Dulciuri in bucatarie",
    tablefoot: "Fotbal de masa",
