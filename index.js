...
const techTags = [".NET Core", ".NET Framework", ".NET MVC", "3D", "Ab Initio", "Abacus", "Ada", "Adobe CS", "AEM", "Airflow", "Airtable", "Amazon DocumentDB", "ABAP", "AJAX", "API", "Appium", "ASP.NET", "AWS", "Active Directory", "ActiveMQ", "Airlock", "Akka", "Android",
  ...
  "Bootstrap", "Bubble", "Business Intelligence", "C", "C#", "C++", "CakePHP", "Camunda", "CAN", "CI/CD", "Citrix", "Cloud", "CMS", "Cosmos DB", "Craft CMS", "CQRS", "CSS", "Cassandra", "Celery", "Ceph", "Cisco", "Clojure", "Cloud Foundry", "Composer", "Computer Vision", "Confluence", "Cordova",
  "CRM", "Cucumber", "CUDA", "Cypress", "D3", "DDD", "DDN", "Dagger", "DApps", "Dapper", "Dart", "Data-Science", "Data Vault", "Data Warehouse", "Delphi", "DevExpress", "DevOps", "Django", "Docker", "Doctrine", "Drupal", "E2E", "EC2", "ELK", "ES6", "ESB", "ETL", "Eclipse", "Eclipse Scout",
  ...
  "Hibernate", "HL7", "IAM", "IBM", "IBM Db2", "IBM Mainframe", "IBM Spectrum", "IBM WebSphere", "ICT", "IaaS", "IdentityIQ", "IDoc", "Indesign", "InfiniBand", "Infor LN", "Informatica", "Integromat", "IntelliJ", "InVision", "Ionic", "IoT", "IT Support", "JBoss", "JHipster", "JIRA", "JPA", "JSON", "JSP", "JUnit", "Jupyter", "JWT", "Jasmine", "Java", "Java EE",
  "JavaFX", "JavaScript", "Jenkins", "Jest", "K2", "KVM", "Kafka", "Kanban", "Karma", "Keras", "Kotlin", "Kubernetes", "LDAP", "LESS", "Laravel", "Leaflet", "Linux", "Liquibase", "Load Balancing", "Looker", "LXC", "LWC",
  ...
  "Oracle", "PHP", "PL SQL", "PWA", "PaaS", "Pacemaker", "Pardot", "Perl", "Phoenix", "Pimcore", "Play Framework", "Polymer", "PostgreSQL", "Postman", "Power BI", "PowerShell", "PrestaShop", "Prometheus", "Product Manager", "Product Owner", "Project Manager", "Puppet", "PyTorch",
  "Python", "QA Testing", "QEMU", "Quobyte", "Qt", "Quarkus", "RDF", "RDMA", "REST", "ReSharper", "RBAC", "RHEL", "ROS", "RPA", "RSpec", "RabbitMQ", "Rails", "React", "React Native", "ReactiveX", "Redgate", "Redis",
  ...
  "Websphere", "Web", "Webflow", "Windows", "Windows Forms", "Wix", "WordPress", "Xcode", "Xdebug", "XML", "XP", "XPath", "XState", "Xamarin", "Yarn", "Zapier", "Zend", "Zeplin", "Zookpeeper", "dbt", "gRPC", "iOS", "jQuery",
