...
const techTags = [".NET Framework", ".NET MVC", "3D", "Ab Initio", "Abacus", "Ada", "Adobe CS", "AEM", "AI", "Airflow", "Airtable", "Akeneo", "Altium Designer", "Amazon DocumentDB",
  ...
  "C", "C#", "C++", "CAFM", "CakePHP", "Camunda", "CAN", "ChatGPT", "CI/CD", "Citrix", "ClickHouse", "ClickUp", "Cloud", "CloudWatch", "CMDB", "CMMS", "CML", "CMS", "COBOL", "CockroachDB", "CodeIgniter", "Cosmos DB", "Craft CMS", "Cryptography", "CODESYS", "CQRS", "CSS", "Cassandra", "Celery", "Celonis", "Ceph", "CheckMK",
