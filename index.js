...
const techTags = [".NET Core", ".NET Framework", ".NET MVC", "3D", "Ab Initio", "Abacus", "Ada", "Adobe CS", "AEM", "Airflow", "Airtable", "Amazon DocumentDB",
  ...
  "Infor LN", "Informatica", "Integromat", "IntelliJ", "InVision", "Ionic", "IoT", "Istio", "IT Support", "JBoss", "JHipster", "JIRA", "JPA", "JSON", "JSP", "JUnit",
  "Jupyter", "JWT", "Jasmine", "Java", "Java EE", "JavaFX", "JavaScript", "Jenkins", "Jest", "JMeter", "K2", "KIS", "KVM", "Kafka", "Kanban", "Karma",
  "Keras", "Kibana", "Kotlin", "Kubernetes", "LDAP", "LESS", "LIS", "Laravel", "Leaflet", "Linux", "Liquibase", "Load Balancing", "Looker", "LXC",
  "LWC", "MS-SQL", "MacBook", "Machine Learning", "Magento", "MariaDB", "Marketing", "Marvel", "Material UI", "Matlab", "Maven", "MediaWiki",
  "Mesos", "Meteor", "Microsoft BizTalk Server", "Microsoft Dynamics 365 BC", "Microsoft Dynamics 365 CRM", "Microsoft Dynamics 365 NAV",
  "Mustache", "Mobile", "MongoDB", "MS Teams", "MQTT", "MVC", "MVVM", "MySQL", "NAT", "Neo4J", "Network", "NextJS", "Nexus", "NFC", "NFS", "Nginx", "NHibernate",
  "NodeJS", "NoSQL", "NuxtJS", "ODI", "OSS", "OWASP", "Objective-C", "Odoo", "Office 365", "Open-E JovianDSS", "OpenGL", "OpenShift", "OpenStack", "Oracle", "PACS", "PHP",
  "PL SQL", "PLC", "PWA", "PaaS", "Pacemaker", "Pardot", "Perl", "Phoenix", "Pimcore", "Play Framework", "plentymarkets", "Polymer", "PostgreSQL", "Postman", "Power BI",
  "PowerShell", "PrestaShop", "Prometheus", "Product Manager", "Product Owner", "Progress OpenEdge", "Profibus", "Profinet", "Project Manager", "Puppet", "PyTorch", "Python",
