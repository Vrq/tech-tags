...
const perkTagsTranslated = {
  en: {
    ...
    discounts: "Discounts for company products",
  ...
  de: {
    ...
    discounts: "Rabatte für Firmenprodukte",
  ...
  ro: {
    ...
    wweek35: "35 de ore săptămână de lucru",
    wweek40: "40 de ore săptămână de lucru",
    wweek42: "42 de ore săptămână de lucru",
    wweek45: "45 de ore săptămână de lucru",
    accooler: "Aer condiționat",
    retreat: "Retragere anuală a companiei",
    beer: "Bere",
    bonuspay: "Remunerație bonus",
    careerpath: "Calea carierei și revizuirea anuală",
    childcare: "Sprijin pentru îngrijirea copiilor",
    hardware: "Clegerea hardware-ului",
    coffee: "Cafea, ceai",
    wageagree: "Contract salarial colectiv",
    coparking: "Parcarea companiei",
    coworkshops: "Ateliere și schimb de cunoștințe",
    conferences: "Conferințe",
    cooloffice: "Birou grozav",
    discounts: "Reduceri pentru produsele companiei",
    equity: "Stocul companiei",
    extraretirement: "Contribuție suplimentară la pensionare",
    flexiblework: "Timp de lucru flexibil",
    freelunch: "Pranz gratuit",
    freshfruits: "Fructe proaspete",
    gym: "Abonament fitness",
    remotefull: "Birou complet acasă / lucru la distanță",
    remote1day: "Home office / Remote 1 zi pe săptămână",
    remote2day: "Birou la domiciliu / telecomandă 2 zile pe săptămână",
    individualbudget: "Buget individual de formare educațională",
    intteam: "Echipa internațională",
    maternity: "Concediu de maternitate / paternitate",
    phonesub: "Abonament telefon mobil",
    parttime: "Posibil cu jumătate de normă",
    pingpong: "Tenis de masa",
    pizza: "Ziua Pizza",
    gatravel: "Abonament complet transport public",
    halffare: "Contribuția transportului public",
    relocation: "Sprijin pentru relocare",
    sabbatical: "Posibilitate sabatică",
    standingdesk: "Birou în picioare",
    startupculture: "Cultura startupului",
    sweets: "Dulciuri în bucătărie",
    tablefoot: "Fotbal de masă",
    teamevents: "Evenimente de echipă",
    quietoffice: "Birou liniștit",
    vacationbonus: "Bonus de vacanță",
