...
const techTags = [".NET Core", ".NET Framework", ".NET MVC", "3D", "Ab Initio", "Abacus", "Ada", "Adobe CS", "AEM", "Airflow", "Amazon DocumentDB", "ABAP", "AJAX", "API", "Appium", "ASP.NET", "AWS", "Active Directory", "ActiveMQ", "Airlock", "Akka", "Android",
  ...
  "Hibernate", "HL7", "IAM", "IBM", "IBM Db2", "IBM Spectrum", "ICT", "IaaS", "IdentityIQ", "IDoc", "Indesign", "InfiniBand", "Infor LN", "Informatica", "IntelliJ", "InVision", "Ionic", "IoT", "IT Support", "JBoss", "JHipster", "JIRA", "JPA", "JSON", "JSP", "JUnit", "Jupyter", "JWT", "Jasmine", "Java", "Java EE",
  ...
  "Oracle", "PHP", "PL SQL", "PWA", "PaaS", "Pardot", "Perl", "Phoenix", "Pimcore", "Play Framework", "Polymer", "PostgreSQL", "Postman", "Power BI", "PowerShell", "Prometheus", "Product Manager", "Product Owner", "Project Manager", "Puppet",
